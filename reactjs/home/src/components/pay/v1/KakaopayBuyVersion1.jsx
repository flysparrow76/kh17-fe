...
export default function KakaopayBuyVersion1() {
    ...
    return(<>
        <Jumbotron title="세상 무식한 결제 테스트" const="실제로 일어날리 없는 방식"/>

        <Row className="mt-5">
            <Form.Label column sm={3}>상품명</Form.Label>
            <Col sm={9}>
            <Form.Control type="text" name="name" placeholder="한우 A++세트"
        ...
        <Row className="mt-5">
            ...
            <Col sm={9}>
            <Form.Control type="text" name="price" placeholder="50000"
