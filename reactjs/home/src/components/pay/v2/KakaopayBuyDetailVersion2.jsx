...
export default function KakaopayBuyDetailVersion2() {
    ...
    const cancelUnit = useCallback(async(detail)=>{
        try{
            ...
            if(result.isConfirmed === false) return;
            const {data} = await apiClient.delete(`/purchase/cancelUnit/${detail.purchaseDetailNo}`)
            toast.success("결제가 취소되었습니다.")
        }
        catch(e){
            toast.success("일시적인 오류 발생했습니다.")
        }
                            ...
                            <div className="flex-grow-1 ms-2">
                                ...
                                */}
                                ...
                                <div className="mt-2 text-end">
                                    <Button variant="danger" size="sm" onClick={e=>cancelUnit(detail)}>
                                        <FaXmark/>
