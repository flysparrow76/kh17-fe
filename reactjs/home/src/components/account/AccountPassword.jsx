...
import { Row,Form, Col, Button, Alert, Toast } from "react-bootstrap";
...
export default function(){
    ...
    //view
    return(<>
        <Jumbotron title="비밀전호 변경" content="현재 비밀번화와 변경하실 비밀번호 입력"/>
        ...
        <Form autoCapitalize="off" onSubmit={sendRequest}>
        ...
        <Row className="mt-5">
            <Col>
                <Button variant="danger" size="lg" className="w-100" onClick={sendRequest}>
