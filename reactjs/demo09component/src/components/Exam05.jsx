...
function Exam05() {
    ...
    <>
        ...
        <div className="row mt-4">
            <label className="col-sm-3 col-form-label">작가</label>
            <div className="col-sm-9">
        ...
        <div className="row mt-4">
            <label className="col-sm-3 col-form-label">출판일</label>
            <div className="col-sm-9">
        ...
        <div className="row mt-4">
            <label className="col-sm-3 col-form-label">가격</label>
            <div className="col-sm-9">
